...
<div class="pageContent">
	<div class="pageFormContent" layoutH="97">
		<dl>
			<dt><hi:text key="菜单名称" entity="Menu"/>：</dt><dd><input type="text" name="menu.menuName" class="textInput" value="${menu.menuName}" /></dd>
		</dl>
		<dl>
			<dt><hi:text key="显示信息" entity="Menu"/>：</dt><dd><input type="text" name="menu.displayRef" class="textInput" value="${menu.displayRef}" /></dd>
		</dl>
		<dl>
			<dt><hi:text key="描述" entity="Menu"/>：</dt><dd><input type="text" name="menu.description" class="textInput" value="${menu.description}" /></dd>
		</dl>
		<dl>
			<dt><hi:text key="父菜单项" entity="Menu"/>：</dt>
			<dd>
				<input type="hidden" name="menu.parentMenu.id" value="${menu.parentMenu.id}"/>
				<input type="text" class="textInput required" name="menu.hi_parentMenu.menuName" value="${menu.parentMenu.menuName}"
