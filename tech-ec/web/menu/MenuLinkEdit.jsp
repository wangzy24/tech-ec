...
<div class="pageContent">
	<div class="pageFormContent" layoutH="97">
		<dl>
			<dt><hi:text key="菜单URL" entity="MenuLink"/>：</dt><dd><input type="text" name="menuLink.linkUrl" class="textInput" value="${menuLink.linkUrl}" /></dd>
		</dl>
		<dl>
			<dt><hi:text key="显示信息" entity="MenuLink"/>：</dt><dd><input type="text" name="menuLink.displayRef" class="textInput" value="${menuLink.displayRef}" /></dd>
		</dl>
		<dl>
			<dt><hi:text key="描述" entity="MenuLink"/>：</dt><dd><input type="text" name="menuLink.description" class="textInput" value="${menuLink.description}" /></dd>
		</dl>
		<dl>
			<dt><hi:text key="权限" entity="MenuLink"/>：</dt><dd><input type="text" name="menuLink.hi_authority.description" class="textInput" value="${menuLink.authority.description}" /></dd>
		</dl>
		<dl>
		...
		<dl>
			<dt><hi:text key="菜单项描述" entity="MenuLink"/>：</dt><dd><input type="text" name="menuLink.hi_menu.description" class="textInput" value="${menuLink.menu.description}"/></dd>
		</dl>
	</div>
	<div class="formBar">
		<ul>
