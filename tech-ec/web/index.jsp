	...
	<div id="layout">
		...
		<div id="leftside">
			...
			<div id="sidebar">
				...
				<menu:useMenuDisplayer name="Velocity" config="menu/sysmenu.html"  bundle="org.apache.struts.action.MESSAGE">
				...
				<div class="navTab-panel tabsPageContent">
					<div>
						<div class="accountInfo">
							...
							<div class="right">
								<p><a href="http://j-hi.googlecode.com/files/deploy.swf" target="_blank" style="line-height:19px">安装部署视频(flash)</a></p>
						...
						<div class="pageFormContent" layoutH="80">
							...
							<p>在线演示地址 http://demo.j-hi.net :)建设中</p>
							...
							<p>WooW工作流演示 http://woow.j-hi.net	帐号/密码  	woow/woow	:)建设中</p>
...
3、为平台增加新技术组件,例如对SpringMVC SpringJDBC及其它优秀开源框架的支持
...
<p style="color:red">QQ群：133176937(满) 133177634(满) 133178083 134232577</p>
						</div>
