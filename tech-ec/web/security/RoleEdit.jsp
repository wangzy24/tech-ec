...
<form action="roleSave.action?navTabId=roleList&callbackType=closeCurrent&ajax=1" method="post" class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone)">
	...
	<div class="pageContent">
	  	<div class="pageFormContent" layoutH="97">
	        <dl>
				<dt><hi:text key="角色名称" entity="Role" />:</dt> <dd><input type="text" name="role.roleName" class="textInput" value="${role.roleName}" /></dd>
			</dl>
			<dl>
				<dt><hi:text key="显示信息" entity="Role" />:</dt> <dd><input type="text" name="role.displayRef" class="textInput" value="${role.displayRef}" /></dd>
			</dl>
			<dl>
				<dt><hi:text key="描述" entity="Role" />:</dt> <dd><input type="text" name="role.description" class="textInput" value="${role.description}" /></dd>
			</dl>
