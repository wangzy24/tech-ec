...
<div class="pageHeader">
	<form rel="pagerForm" method="post" action="userAuthorityList.action" onsubmit="return dwzSearch(this, '${targetType}');">
	<div class="searchBar">
		<ul class="searchContent">	
			...
			<li>
				<label><hi:text key="范围" entity="UserAuthority"/>:</label>
				 <hi:search name="pageInfo.f_scope" emu="securityScope" cssClass="combox"/>
			</li>
		</ul>
		<div class="subBar">
