...
<div class="pageContent">
	<div class="pageFormContent" layoutH="97">
		...
		<dl>
			<dt><hi:text key="用户类型" entity="HiUser"/>：</dt><dd> <hi:select cssClass="combox" emu="userType" name="hiUser.userMgrType" defaultValue="1402" filterPattern="<%=filterUserType%>"/></dd>
		</dl>
