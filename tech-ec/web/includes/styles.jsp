...
<script src="styles/dwz/js/jquery-1.4.4.js" type="text/javascript"></script>
...
<script src="styles/xheditor/xheditor-zh-cn.min.js" type="text/javascript"></script>
...
<script src="styles/dwz/js/dwz.jDialog.js" type="text/javascript"></script>
...
<script src="styles/dwz/js/dwz.hi.js" type="text/javascript"></script>
