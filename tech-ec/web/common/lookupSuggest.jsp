...
<%response.setContentType("text/xml");
	...
	String lookupPrivilege = (String)request.getParameter("lookupPrivilege");
	...
	List reslut = bMgr.getObjectsForLookup(Class.forName(className),inputValue, lookupSearchFields,lookupPrivilege, sarchPageInfo);
