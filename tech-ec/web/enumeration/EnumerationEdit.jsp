...
<div class="pageContent">
	<div class="pageFormContent" layoutH="97">
		<dl>
			<dt><hi:text key="枚举名称" entity="Enumeration"/>：</dt><dd><input type="text" name="enumeration.enName" class="textInput" value="${enumeration.enName}" /></dd>
		</dl>
		<dl>
			<dt><hi:text key="显示信心" entity="Enumeration"/>：</dt><dd><input type="text" name="enumeration.displayRef" class="textInput" value="${enumeration.displayRef}" /></dd>
		</dl>
		<dl>
			<dt><hi:text key="描述" entity="Enumeration"/>：</dt><dd><input type="text" name="enumeration.description" class="textInput" value="${enumeration.description}" /></dd>
		</dl>
			...
			<div class="tabsContent" style="height:120px;">
				<div style="overflow: auto">
					<table class="list nowrap" width="100%" itemDetail="enumeration.enumerationValues">
						<thead>
							<tr>
								<th type="text" name="valueName" size="12"><hi:text key="枚举值名称" entity="EnumerationValue"/></th>
								<th type="text" name="displayRef" size="12"><hi:text key="显示信息" entity="EnumerationValue"/></th>
								<th type="text" name="description" size="12"><hi:text key="描述" entity="EnumerationValue"/></th>
						...
						<tbody>
							...
							<input type="hidden" name="enumeration.enumerationValues[${enumerationValueIndex.index}].id" value="${enumerationValue.id}"/>
								<td>
									<input type="text" name="enumeration.enumerationValues[${enumerationValueIndex.index}].valueName" value="${enumerationValue.valueName}" size="12"/>
								</td>
								<td>
									<input type="text" name="enumeration.enumerationValues[${enumerationValueIndex.index}].displayRef" value="${enumerationValue.valueName}" size="12"/>
								</td>
								<td>
									<input type="text" name="enumeration.enumerationValues[${enumerationValueIndex.index}].description" value="${enumerationValue.displayRef}" size="12"/>
								</td>
