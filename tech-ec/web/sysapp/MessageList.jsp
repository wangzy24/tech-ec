...
<div class="pageHeader">
	<form rel="pagerForm" method="post" action="masterList.action" onsubmit="return dwzSearch(this, '${targetType}');">
	<div class="searchBar">
		<ul class="searchContent">	
			...
			<li>
				...
				<hi:search name="pageInfo.f_messageType" emu="messageType" cssClass="combox"/>
			</li>	  
			<li>
			...
			<li class="dateRange">
				...
				<hi:search name="pageInfo.f_isSent" emu="yesNo" cssClass="combox"/>
			</li>	  
		</ul>
		<div class="subBar">
