...
<div class="pageContent">
	<div class="pageFormContent" layoutH="97">
		<dl>
			<dt><hi:text key="报表名称" entity="ExcelReportDesign"/>：</dt><dd><input type="text" name="excelReportDesign.reportName" class="textInput" value="${excelReportDesign.reportName}" /></dd>
	    </dl>
	    <dl>
		...
		<dl>
			<dt><hi:text key="激活" entity="ExcelReportDesign"/>：</dt><dd><hi:select cssClass="combox" emu="yesNo" name="excelReportDesign.enabled"/></dd>			
		</dl>
		<dl>
			<dt><hi:text key="Action类(全限定名)" entity="ExcelReportDesign"/>：</dt><dd><input type="text" name="excelReportDesign.actionName" class="textInput" value="${excelReportDesign.actionName}" /></dd>
	    </dl>
		 <dl>
