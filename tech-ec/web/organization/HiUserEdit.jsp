...
<div class="pageContent">
	<div class="pageFormContent" layoutH="97">
		...
		<dl>
			<dt><hi:text key="性别" entity="HiUser"/>：</dt><dd><hi:select cssClass="combox" emu="gender" name="hiUser.gender"/></dd>			
		</dl>
		<dl>
		...
		<dl>
			<dt><hi:text key="时区" entity="HiUser"/>：</dt><dd><hi:entitySelect entityName="org.hi.i18n.model.Timezone" key="timezone" title="description" cssClass="combox" name="hiUser.timeZone" /></dd>
		</dl>
		<dl>
			<dt><hi:text key="语言" entity="HiUser"/>：</dt><dd><hi:entitySelect entityName="org.hi.i18n.model.LanguageCode" key="id" title="description" cssClass="combox" name="hiUser.country" /></dd>
		</dl>
		<dl>
