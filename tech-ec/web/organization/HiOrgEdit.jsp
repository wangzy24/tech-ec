...
<div class="pageContent">
	<div class="pageFormContent" layoutH="97">
		<dl>
			<dt><hi:text key="部门名称" entity="HiOrg"/>：</dt><dd><input type="text" name="hiOrg.orgName" class="textInput" value="${hiOrg.orgName}" /></dd>
		</dl>
		<dl>
		...
		<dl>
			<dt><hi:text key="描述" entity="HiOrg"/>：</dt><dd><input type="text" name="hiOrg.description" class="textInput integer" value="${hiOrg.description}" /></dd>
		</dl>			
	</div>
	<div class="formBar">
		<ul>
