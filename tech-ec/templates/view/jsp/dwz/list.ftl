...
<div class="pageHeader">
	<form rel="pagerForm" method="post" action="${entity.entityName?uncap_first}List.action" onsubmit="return dwzSearch(this, '<#noparse>${</#noparse>targetType<#noparse>}</#noparse>');">
	<div class="searchBar">
